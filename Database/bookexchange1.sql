...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2019 at 04:02 PM
...
CREATE TABLE `book` (
  `id` int(10) NOT NULL,
  `bookTitle` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `bookAuthor` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `publicationYear` date DEFAULT NULL,
  `bookCategory` int(11) DEFAULT NULL,
  `userId` int(11) DEFAULT NULL,
  `isActive` bit(1) DEFAULT NULL,
  `bookImage` varchar(500) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `bookPrice` float(10,2) DEFAULT NULL,
  `bookQuantity` int(11) DEFAULT NULL,
  `bookDescription` text COLLATE utf8_vietnamese_ci,
...
INSERT INTO `book` (`id`, `bookTitle`, `bookAuthor`, `publicationYear`, `bookCategory`, `userId`, `isActive`, `bookImage`, `bookPrice`, `bookQuantity`, `bookDescription`, `bookState`) VALUES
(1, 'Chuyện Lính Tây Nam', 'Trung Sỹ ', '2019-09-03', 2, 11, b'1', 'chuyen-linh-tay-nam.jpg', 95000.00, 5, 'Gần 5 năm từ 1978 đến 1983 được gói gọn lại trong 300 trang sách chia thành 120 đoản khúc mô tả sự thực đã xảy ra ở chiến trường Tây Nam, một sự thật trần trụi “Nó không chỉ có “anh dũng lao lên” mà đó còn là cuộc sống hiện tại của ...', 2),
(2, 'Anh Là Tất Cả Những Gì Em Ghét Nhất ', 'Tiểu Bố Thích Ăn Bánh Trứng ', '2019-04-04', 2, 14, b'1', 'anh-la-tat-ca-nhung-gi-em-ghet-nhat.jpg', 87000.00, 10, 'Cuốn sách là tập hợp những mẩu chuyện ngắn ấm áp và hài hước, giống như một cuốn nhật ký ghi lại quãng thời gian yêu nhau của hai nhân vật chính Tiểu Bố và Tam Gia. Họ quen biết nhau từ năm đầu cấp ba, và chính thức trở thành người yêu khi học ... ', 2),
(3, 'Mục Đích Sống Của Một Chú Chó', 'W.Bruce Cameron ', '2019-03-01', 2, 13, b'1', 'muc-dich-song-cua-mot-chu-cho.jpg', 102000.00, 1, 'Đây là câu chuyện cảm động của một chú chó - trải qua rất nhiều kiếp sống chỉ để tự hỏi: mục đích sống của loài chó là gì. Truyện còn là những lát cắt cuộc sống và những mối quan hệ của loài người dưới cái nhìn của động vật bốn ... ', 3),
(4, 'Chuyện Của Heo', 'Tuyệt Đỉnh Sinh Vật ', '2016-06-09', 5, 13, b'1', 'chuyen-cua-heo.jpg', 87000.00, 1, 'Đây không phải là cuốn truyện dành cho thiếu nhi, nó là cuốn sách dành cho những người lớn muốn tìm lại sự trẻ con trong chính mình.Khi phải sống mỗi ngày, trưởng thành rồi ai cũng già đi.Hơn cả một quyển sách, được sáng tạo cần mẫn và tỉ mỉ ...', 1),
...
(6, 'Tuổi Trẻ Đáng Giá Bao Nhiêu', 'Rosie Nguyễn', '2016-10-01', 7, 12, b'1', 'tuoi-tre-dang-gia-bao-nhieu.jpg', 41000.00, 18, 'Bạn hối tiếc vì không nắm bắt lấy một cơ hội nào đó, chẳng có ai phải mất ngủ.\r\n\r\nBạn trải qua những ngày tháng nhạt nhẽo với công việc bạn căm ghét, người ta chẳng hề bận lòng.\r\n\r\nBạn có chết mòn nơi xó tường với những ước mơ dang dở, đó không phải là việc của họ.\r\n\r\nSuy cho cùng, quyết định là ở bạn. Muốn có điều gì hay không là tùy bạn.', 1),
(7, 'Nhà Giả Kim', 'Paulo Coelho', '2013-10-01', 1, 11, b'1', 'nha-gia-kim.jpg', 48000.00, 12, 'Tất cả những trải nghiệm trong chuyến phiêu du theo đuổi vận mệnh của mình đã giúp Santiago thấu hiểu được ý nghĩa sâu xa nhất của hạnh phúc, hòa hợp với vũ trụ và con người.\r\n\r\nTiểu thuyết Nhà giả kim của Paulo Coelho như một câu chuyện cổ tích giản dị, nhân ái, giàu chất thơ, thấm đẫm những minh triết huyền bí của phương Đông. Trong lần xuất bản đầu tiên tại Brazil vào năm 1988, sách chỉ bán được 900 bản', 2),
(8, 'Đắc Nhân Tâm (Khổ Lớn)', 'Dale Carnegie', '2016-03-01', 7, 11, b'1', 'dac-nhan-tam.jpg', 50000.00, 1, 'Tại sao Đắc Nhân Tâm luôn trong Top sách bán chạy nhất thế giới?\r\n\r\nBởi vì đó là cuốn sách mọi người đều nên đọc.', 3),
(9, 'Giới Hạn Của Bạn Chỉ Là Xuất Phát Điểm Của Tôi', 'Mèo Maverick', '2019-04-03', 7, 14, b'1', 'gioi-han-cua-ban-cung-chi-la-xuat-phat-diem-cua-toi.jpg', 57400.00, 12, 'Giới hạn là gì?\r\n\r\nGiới hạn liệu có phải ranh giới an toàn của mỗi người?\r\n\r\nCó lẽ không, giới hạn là để phá bỏ\r\n\r\nBởi giới hạn của bạn chỉ là xuất phát điểm của người khác.', 2),
...
INSERT INTO `bookcategory` (`id`, `category`) VALUES
(1, 'Sách Văn Học Trong Nước'),
(2, 'Sách Văn Học Nước Ngoài'),
(3, 'Sách Kinh Tế'),
(4, 'Sách Ngoại Văn'),
(5, 'Truyện Tranh Khác'),
(6, 'Sách Phát Triển Bản Thân'),
(7, 'Kỹ Năng Sống'),
(8, 'Tiểu Thuyết Lãng Mạn'),
(9, 'Văn Học Thiếu Nhi');
...
CREATE TABLE `user` (
  ...
  `email` varchar(320) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `password` varchar(300) COLLATE utf8_vietnamese_ci DEFAULT NULL,
...
(11, 'ngà', 'huynhphuocnga97@gmail.com', '$2a$10$yVpDZ2nH4ojN0QFirQlqHOk2uOxRbpNdrJOedn5AQAtg3BEkqF64K', NULL),
(12, 'Thanh Phương', 'phuongbestad@gmail.com', 'tuididuongcorong', NULL),
(13, 'Quang Thiện', 'thienchamhoc@gmail.com', 'ahihidongoc', NULL),
(14, 'Hồng Thái', 'thaibestyasou@gmail.com', 'rungcudetuilo', NULL),
(15, 'm', 'nga@gmail.com', '$2a$10$3ejLuEkacBv9jCBcTzUZOeZCL/Wk00OOCW3EEcYJhumlp7Il6BD4W', NULL);
...
ALTER TABLE `book`
  ...
  ADD KEY `bookCategory` (`bookCategory`) USING BTREE,
  ADD KEY `userId` (`userId`) USING BTREE,
  ADD KEY `bookState` (`bookState`) USING BTREE;
...
--
ALTER TABLE `book`
  ADD CONSTRAINT `FK3yxi7uidtobof0b96q7wpltb` FOREIGN KEY (`bookState`) REFERENCES `state` (`id`),
  ADD CONSTRAINT `FK9tgww7fu2ldi7h76a6a04m4o3` FOREIGN KEY (`userId`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FKl4gnu9q801l419cj9ce5yqg8w` FOREIGN KEY (`bookCategory`) REFERENCES `bookcategory` (`id`),
  ADD CONSTRAINT `book_ibfk_1` FOREIGN KEY (`bookCategory`) REFERENCES `bookcategory` (`id`),
  ADD CONSTRAINT `book_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `book_ibfk_3` FOREIGN KEY (`bookState`) REFERENCES `state` (`id`);
COMMIT;
